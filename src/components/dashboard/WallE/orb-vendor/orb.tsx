/**
 * ElevenLabs UI — Orb component
 * Source: https://ui.elevenlabs.io/r/orb.json
 * Upstream registry: https://ui.elevenlabs.io
 * License: MIT (https://github.com/elevenlabs/elevenlabs-ui/blob/main/LICENSE)
 *
 * Vendored verbatim on 2026-05-22 because @elevenlabs/ui is not published to npm
 * (shadcn-style registry). Do not edit this file directly — re-fetch from the
 * registry to update. WallE-specific behavior lives in WallEOrb.tsx.
 */
"use client"
